...
pub struct OrderBook {
    ...
    pub(super) bids: BTreeMap<Reverse<Price>, VecDeque<RestingOrder>>,
    ...
    pub(super) resting_orders: BTreeMap<OrderSeq, (Side, Price)>,
    /// Sequences of orders that were fully filled since the last drain.
    pub(super) filled_orders: BTreeSet<OrderSeq>,
}
