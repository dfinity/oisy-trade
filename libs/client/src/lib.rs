...
use oisy_trade_types::{
    ...
    GetMyOrdersError, GetMyTradesError, GetOrderBookDepthError, GetOrderBookDepthRequest,
    GetOrderBookTickerError, LimitOrderRequest, OrderBookDepth, OrderBookTicker, OrderId,
    OrderRecord, Token, TokenId, Trade, TradesFilter, TradingPair, TradingPairInfo,
...
impl<R: Runtime> OisyTradeClient<R> {
    ...
    pub async fn get_my_trades(
        ...
        self.runtime
            .call(self.oisy_trade_canister, "get_my_trades", (filter,), 0)
            .await
            .unwrap()
    }
