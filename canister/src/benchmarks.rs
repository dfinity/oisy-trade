...
struct BidSweepSetup {
    state: State<storage::VMem, storage::VMem>,
    pair: TradingPair,
    bids_len: usize,
}

/// Build the shared bid-sweep setup: a fully-populated Binance ICP/USDT book
...
fn setup_bid_sweep(
    ...
    place_order(
        ...
        PendingOrder {
            ...
            quantity: Quantity::from_u128(quantity_for(total_bid_qty)),
            time_in_force,
        },
    );
